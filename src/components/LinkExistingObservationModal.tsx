...
export function LinkExistingObservationModal({
  claimId,
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      await api.createObservationClaimLink(observationId, {
        claimId,
        relationshipType,
      });
      invalidateStats();
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="link-observation-title"
      onClick={onClose}
    >
      <div
      ...
      >
        <h3 id="link-observation-title" className="text-lg font-semibold text-stone-900">
